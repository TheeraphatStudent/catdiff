...
UploadRespone uploadResponeFromJson(String str) =>
    UploadRespone.fromJson(json.decode(str));
...
class UploadRespone {
  ...
  UploadRespone({required this.message, required this.data});
...
class Data {
  ...
  Data({required this.filename, required this.url, required this.provider});
